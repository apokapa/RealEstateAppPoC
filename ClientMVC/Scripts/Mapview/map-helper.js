var MapHelper = (function (mapElement, pinPath) {
    var clusterStyles = [
        {
            url: '/Content/Mapview/images/cluster-1.png',
            textColor: 'white',
            textSize: 16,
            height: 52,
            width: 52
        }, {
            url: '/Content/Mapview/images/cluster-2.png',
            textColor: 'white',
            textSize: 17,
            height: 55,
            width: 56
        }, {
            url: '/Content/Mapview/images/cluster-3.png',
            textColor: 'white',
            textSize: 18,
            height: 65,
            width: 66
        }, {
            url: '/Content/Mapview/images/cluster-4.png',
            textColor: 'white',
            textSize: 19,
            height: 89,
            width: 90
        }, {
            url: '/Content/Mapview/images/cluster-5.png',
            textColor: 'white',
            textSize: 20,
            height: 77,
            width: 78
...
})(document.getElementById("map"), "/Content/Mapview/images/pin.png");